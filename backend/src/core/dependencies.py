...
from src.repository.storage.storage_repository import LocalStorageRepository, S3StorageRepository
...
storage_repository = S3StorageRepository(os.getenv("BUCKET_NAME"), os.getenv("aws_access_key_id"), os.getenv("aws_secret_access_key"))
